    ...
    a = r*cos(th);
    b = r*sin(th);
    surf(handles.axes1,[a; a]+x(1), [b; b]+y(1), [ones(1,size(th,2)); zeros(1,size(th,2))]*hgt1, 'FaceColor',[151 255 255]/255, 'EdgeColor','none','FaceAlpha',opacity);
    ...
    r = 50;
    hgt1 = -15;
    th = (-126/180*pi):pi/100:(126/180*pi);
    a = r*cos(th);
    b = r*sin(th);
    surf(handles.axes1,[a; a]+x(1), [b; b]+y(1), [ones(1,size(th,2)); zeros(1,size(th,2))]*hgt1, 'FaceColor',[151 255 255]/255, 'EdgeColor','none','FaceAlpha',opacity);

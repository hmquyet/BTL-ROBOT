function planning_Lspb(handles)
...
% global yaw;
 ...
 [q_theta1, v_theta1, a_theta1, J_theta1, t_theta1]=lspb(q_Theta1_max,v_max,a_max,theta1);
 [q_theta2, v_theta2, a_theta2, J_theta2, t_theta2]=lspb(q_Theta2_max,v_max,a_max,theta2);
 [q_d3, v_d3, a_d3, J_d3, t_d3]=lspb(q_d3_max,v_max,a_max,d3);
 [q_theta4, v_theta4, a_theta4, J_theta4, t_theta4]=lspb(q_Theta4_max,v_max,a_max,theta4);
...
% set_param('PIDController/motor1/Integrator','InitialCondition',q_theta1);
% set_param('PIDController/motor2/Integrator','InitialCondition',q_theta2*pi/180);
% set_param('PIDController/motor3/Integrator','InitialCondition',d3);
% set_param('PIDController/motor4/Integrator','InitialCondition',q_theta4);
% 
%  sim('PIDController', 'SimulationMode', 'normal', 'StopTime', 'inf');
...
[q, v, a, J, t]=lspb(q_max,v_max,a_max,0);
...
% 
% q_theta1_PV = q_theta1_PV(1:step:end);
% q_theta2_PV = q_theta2_PV(1:step:end);
% q_d3_PV = q_d3_PV(1:step:end);
% q_theta4_PV = q_theta4_PV(1:step:end);
% 
% v_theta1_PV = v_theta1_PV(1:step:end);
% v_theta2_PV = v_theta2_PV(1:step:end);
% v_d3_PV = v_d3_PV(1:step:end);
% v_theta4_PV = v_theta4_PV(1:step:end);
% 
% a_theta1_PV = a_theta1_PV(1:step:end);
% a_theta2_PV = a_theta2_PV(1:step:end);
% a_d3_PV = a_d3_PV(1:step:end);
% a_theta4_PV = a_theta4_PV(1:step:end);
% 
% j_theta1_PV = j_theta1_PV(1:step:end);
% j_theta2_PV = j_theta2_PV(1:step:end);
% j_d3_PV =j_d3_PV(1:step:end);
% j_theta4_PV = j_theta4_PV(1:step:end);
    for i=1:step
